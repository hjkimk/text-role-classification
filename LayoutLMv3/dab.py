...
class CustomLayoutLMv3ForTokenClassification(LayoutLMv3ForTokenClassification):
    """
    Custom token classification class.
    Edited from original LayoutLMv3.
    """
    def __init__(self, config, classifier):
        ...
        #if config.num_labels < 10: # modified
    ...
    def forward(
        ...
        if labels is not None:
            ...
            loss_fct = CrossEntropyLoss(weight=self.weights)  # modified
